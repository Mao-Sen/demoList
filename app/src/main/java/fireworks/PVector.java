package fireworks;/* -*- mode: java; c-basic-offset: 2; indent-tabs-mode: nil -*- */
...
public class PVector implements Serializable {
     ...
     * @return the random PVector
     */
    static public PVector random2D(fireworks.PContext parent) {
     ...
     * @return the random PVector
     */
    static public PVector random2D(PVector target, fireworks.PContext parent) {
        if (parent == null) return fromAngle((float)(Math.random()*Math.PI*2),target);
        else                return fromAngle(parent.random(fireworks.PContext.TWO_PI),target);
    }
     ...
     * @return the random PVector
     */
    static public PVector random3D(fireworks.PContext parent) {
     ...
     * @return the random PVector
     */
    static public PVector random3D(PVector target, fireworks.PContext parent) {
        float angle;
        float vz;
        if (parent == null) {
            ...
            angle = parent.random(fireworks.PContext.TWO_PI);
    ...
    public void rotate(float theta) {
        ...
        x = x* fireworks.PContext.cos(theta) - y* fireworks.PContext.sin(theta);
        y = xTemp* fireworks.PContext.sin(theta) + y* fireworks.PContext.cos(theta);
    }
    ...
    public void lerp(PVector v, float amt) {
        x = fireworks.PContext.lerp(x,v.x,amt);
        y = fireworks.PContext.lerp(y,v.y,amt);
        z = fireworks.PContext.lerp(z,v.z,amt);
    }
    ...
    public void lerp(float x, float y, float z, float amt) {
        this.x = fireworks.PContext.lerp(this.x,x,amt);
        this.y = fireworks.PContext.lerp(this.y,y,amt);
        this.z = fireworks.PContext.lerp(this.z,z,amt);
    }
